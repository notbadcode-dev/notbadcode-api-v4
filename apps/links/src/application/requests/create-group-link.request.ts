...
class RgbColorDto {
  @ApiProperty({ description: 'Red component (0-255)', example: 255 })
  ...
  @ApiProperty({ description: 'Green component (0-255)', example: 128 })
  @IsInt({ message: GroupLinksErrorMessageConstants.invalidColor })
  @Min(0, { message: GroupLinksErrorMessageConstants.invalidColor })
  @Max(255, { message: GroupLinksErrorMessageConstants.invalidColor })
  g!: number;

  @ApiProperty({ description: 'Blue component (0-255)', example: 0 })
  @IsInt({ message: GroupLinksErrorMessageConstants.invalidColor })
  @Min(0, { message: GroupLinksErrorMessageConstants.invalidColor })
  @Max(255, { message: GroupLinksErrorMessageConstants.invalidColor })
  b!: number;
...
export class CreateGroupLinkRequest {
  @ApiProperty({ description: 'Group link title', example: 'My Group', maxLength: LengthSizes.regular })
  ...
  @ApiPropertyOptional({ description: 'Parent group link ID', example: 1, type: Number, nullable: true })
  @IsOptional()
