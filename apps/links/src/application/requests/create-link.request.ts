...
export class CreateLinkRequest {
  ...
  @IsNotEmpty({ message: LinksErrorMessageConstants.invalidUrl })
  ...
  @ApiPropertyOptional({ description: 'Group link ID to assign this link to', example: 1, type: Number, nullable: true })
  @IsOptional()
