import { type FindOneOptions, type FindOptionsOrder } from 'typeorm';
...
export interface ILinkRepository {
  ...
  findAndCount(options: { skip: number; take: number; order?: FindOptionsOrder<Link> }): Promise<[Link[], number]>;
